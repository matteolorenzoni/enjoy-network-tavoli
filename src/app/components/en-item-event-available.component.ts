...
@Component({
  ...
  template: `
    <li
      class="group relative mx-auto my-4 flex aspect-square w-full flex-col overflow-hidden rounded-lg bg-slate-900 md:w-3/5"
      (click)="goToSelector()">
      <img
        role="button"
      ...
      <div class="absolute bottom-0 left-0 flex w-full p-2 backdrop-blur">
        <div>
